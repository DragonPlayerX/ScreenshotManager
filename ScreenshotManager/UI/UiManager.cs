...
namespace ScreenshotManager.UI
{
    public class UiManager
    {
        ...
        public static void UiInit()
        {
            ...
            modalAlertMethod = MethodUtils.FindMethod("ModalAlert", () => typeof(ModalAlert).GetMethods().First(method => method.Name.StartsWith("Method_Public_Void_String_") && method.GetParameters().Length == 1 && !method.Name.Contains("PDM")));
