...
namespace ScreenshotManager.UI
{
    public class UiManager
    {
        ...
        public static void UiInit()
        {
            ...
            openSubMenuMethod = MethodUtils.FindMethod("Open SubMenu", () => typeof(UIPage).GetMethods().First(method => method.Name.StartsWith("Method_Public_Void_UIPage_TransitionType_") && method.GetParameters().Length == 2 && MethodUtils.IsUsingMethod(method, "Add") && MethodUtils.IsUsedByType(method, typeof(MenuStateController))));
